  ...
  tab_contents: [
    {
      ...
      text_1: (
        <>
          We are a team of passionate business consultant,s & Technology <br />{" "}
          veterans eager to help companies rech their full potential.
        </>
      ),
      text_2: (
        <>
          By understanding the client,s condition and leveraging our best
          experience and knowledge. we support reform by recommending the most
          appropriate methods and resources.By understanding the client,s
          condition and leveraging our experience and knowledge. we support
          reform by recommending the most .
        </>
      ),
    },
    {

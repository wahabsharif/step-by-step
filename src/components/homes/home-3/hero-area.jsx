...
const hero_contents = {
  title: (
    <>
      Step By Step helps your teams move work{" "}
  ...
  text: "At Step By Step we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast efficiency",
